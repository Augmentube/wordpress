...
if ( ! class_exists( 'VW_Sports_Plugin_Activation_Settings' ) ) {
	...
	class VW_Sports_Plugin_Activation_Settings {
        ...
        public function __construct() {
            ...
            add_filter( 'vw_sports_recommended_plugins', array($this, 'vw_sports_recommended_plugins_array') );
        ...
        public function enqueue_scripts() {
            ...
            wp_register_script( 'vw-sports-plugin-activation-script', get_template_directory_uri() . '/assets/js/plugin-activation.js', array('jquery') );
