    ...
    <div class="content">
	  ...
	  ?>
       ...
       <div class="uimrow" id="from_email_name_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_smtp',0)==0){echo 'display:block;';} else { echo 'display:none;';} ?>">
        ...
        <div class="uimnote"><?php esc_html_e("The <i>Sender's Name</i> inside the header of emails delivering notifications to the admin and the members.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="childfieldsrow" id="enable_smtp_html" style="<?php if($dbhandler->get_global_option_value('pm_enable_smtp',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
        ...
        <div class="uimnote"><?php esc_html_e("Host Server name. For e.g.<i>smtp.gmail.com</i> if you wish to use Gmail. Consult your SMTP service provider for exact name.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php esc_html_e('SMTP port. Usually number. For e.g. <i>465</i>','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php esc_html_e('The <i>From</i> name in your outgoing emails. For e.g. <i>John Doe</i>, <i>Acme Corp.</i> etc.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
