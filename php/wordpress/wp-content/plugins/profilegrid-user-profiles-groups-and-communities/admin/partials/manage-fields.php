...
<div class="pm-group-fields-modal" id="pm-group-fields-popup" style="display: none;">
 ...
 <div class="pm-group-fields-popup-wrap pm-group-fields-popup-out">
    <div class="pm-popup-header">
        ...
        <div class="pm-popup-field-box" onClick="add_pm_field('google', '<?php echo esc_attr($gid); ?>')">
            <div class="pm-popup-field-name">
                <i class="fa fa-google-plus" aria-hidden="true"></i>
                <?php esc_html_e('Google+','profilegrid-user-profiles-groups-and-communities'); ?>
            </div>
            <div class="pm-popup-field-details"><?php esc_html_e("A speciality URL field for asking Google+ Profile page.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
        </div>
