...
<?php esc_html_e('Placeholder text:','profilegrid-user-profiles-groups-and-communities'); ?>
                    ...
                    <div class="uimnote"><?php esc_html_e('Placeholder text appears inside input box as guidelines to the user. It disappears when the user clicks on the input box. For e.g. <i>Enter your age</i> inside a number input box.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
...
<?php esc_html_e('CSS Class Attribute:','profilegrid-user-profiles-groups-and-communities'); ?>
                    ...
                    <div class="uimnote"><?php esc_html_e('If you know a bit of CSS, you can create and assign a custom class to this field. Just enter the name of the class as it appears in your stylesheet. For e.g. <i>my-input-class</i>','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
...
<?php esc_html_e('First Option Value:','profilegrid-user-profiles-groups-and-communities'); ?>
                    ...
                    <div class="uimnote"><?php esc_html_e('Add options for your selection field below. Click on <i>Click to add option</i> to add an extra option to existing ones.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
...
<?php esc_html_e('Profile Field Icon','profilegrid-user-profiles-groups-and-communities'); ?>
                ...
                <div class="uimnote"> <?php esc_html_e('Icons appear at the beginning of the label in Default registration forms and User Profiles. For best results use a square image. For e.g. <i>16px x 16px, 256px x 256px, 512px x 512px</i>...','profilegrid-user-profiles-groups-and-communities'); ?></div>
            </div>
...
?>
                ...
                <div class="uimnote"><?php esc_html_e('If you have multiple Profile sections in this group, you can move the field to a different section here. By default, each new field is added to the first section. For e.g. moving a date field labelled <i>Date of Birth</i> from <i>Career</i> section to <i>About</i> section.','profilegrid-user-profiles-groups-and-communities'); ?></div>
            </div>
