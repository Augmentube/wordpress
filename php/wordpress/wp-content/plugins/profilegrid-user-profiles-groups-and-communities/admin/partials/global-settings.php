...
<?php endif;?>
    ...
    <div class="pg-extension-modal-icon"> <img src="<?php echo esc_url($path.'images/menu_restrictions.png');?>" class="options" alt="options"></div>
        ...
        <div class="pg-extension-modal-title"> <?php esc_html_e( 'Menu Restrictions','profilegrid-user-profiles-groups-and-communities' ); ?></div>
        <div class="pg-extension-modal-subhead"><?php esc_html_e( 'Define groups to show/ hide menus.','profilegrid-user-profiles-groups-and-communities' ); ?></div>
        <div class="pg-extension-modal-active-extension"><?php esc_html_e( '<strong>Congratulations</strong>, you have successfully installed and activated this extension!','profilegrid-user-profiles-groups-and-communities' ); ?></div>
        <div class="pg-extension-modal-des">
            <?php esc_html_e( 'You can find options for this extension inside Dashboard &#8594; Appearance &#8594; Menus. When you edit or add a new menu item in one of your menus, you will now see a new option to show or hide it for specific group members. You can find more details', 'profilegrid-user-profiles-groups-and-communities' ); ?>
    ...
    <div class="pg-extension-modal-icon"> <img src="<?php echo esc_url($path.'images/pg-ep-integration.png');?>" class="options" alt="options"></div>
        ...
        <div class="pg-extension-modal-des">
            <?php esc_html_e( 'You will find event specific group options on installing our EventPrime plugin. You can download and install it from the official WordPress repository by visiting <a href="https://wordpress.org/plugins/eventprime-event-calendar-management/" target="_blank">page</a> Once it is installed and activated, on creating or editing events, you will see options to tie the event to specific membership groups. You can find more details', 'profilegrid-user-profiles-groups-and-communities' ); ?>
    ...
    <div class="pg-extension-modal-icon"> <img src="<?php echo esc_url($path.'images/hero-banner.png');?>" class="options" alt="options"></div>
        ...
        <div class="pg-extension-modal-des">
            <?php esc_html_e( 'You can now add banners on your website which show profile images of your users as attractive grids! Just head on to Dashboard &#8594; Appearance &#8594; Widgets, and find a new widget named Hero Banner. It has a bunch of configurable option to match your site’s look and theme and can fit inside any widget position. <a href="https://profilegrid.co/add-user-hero-banner-wordpress/" target="_blank"> Learn more.</a> ', 'profilegrid-user-profiles-groups-and-communities' ); ?>
