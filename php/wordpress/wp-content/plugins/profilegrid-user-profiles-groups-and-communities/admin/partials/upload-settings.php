    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uiminput">
          ...
          <div class="uimnote"><?php printf(esc_html__('Set an upper limit to the size of profile images uploaded by users. Sizes are in Bytes. For example, for 2MB limit use 2097152. You can also use an <a href="%s" target="_blank">online convertor</a> for finding out exact values.','profilegrid-user-profiles-groups-and-communities'),'http://whatsabyte.com/P1/byteconverter.htm');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php printf(esc_html__('Set an upper limit to the size of cover images uploaded by users. Sizes are in Bytes. For example, for 2MB limit use 2097152. You can also use an <a href="%s" target="_blank">online convertor</a> for finding out exact values.','profilegrid-user-profiles-groups-and-communities'),'http://whatsabyte.com/P1/byteconverter.htm');?></div>
      </div>
